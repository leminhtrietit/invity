...
export function TemplateDeviceFrame({ children }: { children: ReactNode }) {
  ...
  return <div className="preview-workbench">
    ...
    <div className="preview-canvas"><div className="preview-device" style={{ maxWidth: device.width }}>{children}</div></div>
  </div>;
}
